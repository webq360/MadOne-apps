// ignore_for_file: avoid_print, use_build_context_synchronously, non_constant_identifier_names, invalid_use_of_visible_for_testing_member, invalid_use_of_protected_member, unused_element, prefer_const_constructors, unused_local_variable
...
class _SeeAllProductScreenState extends State<SeeAllProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: inProgress && allproductsList.isEmpty
          ? ShimmerWidget()
          : Padding(
